 ...
 * 
 * Gives all the methods related to the graphical text view. Made to display user's interaction in a graphical interface using a text window and input boxes.
 */
